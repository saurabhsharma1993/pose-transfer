...
class opts():
    ...
    def init(self):
        ...
        self.parser.add_argument("--data_Dir", default='/home/project/saurabh/pose-gan-clean/pose-gan-h36m-fg/data/', help="Directory with annotations and data")
        ...
        self.parser.add_argument("--learning_rate", default=2e-4, type=float, help='Weight of l1 loss')
        ...
        self.parser.add_argument("--warp_skip", default='none', choices=['none', 'full', 'mask'],
